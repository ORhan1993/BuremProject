    ...
    public partial class BuremDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Therapist>(entity =>
            {
                ...
                entity.Property(e => e.Email).HasMaxLength(255); // YENİ EKLENDİ
                entity.Property(e => e.RoleId).HasDefaultValue(4);

                entity.Property(e => e.IsActive).IsRequired().HasDefaultValue(true);
                entity.Property(e => e.TherapistTypeId).HasDefaultValue(2);
                entity.Property(e => e.CampusId).HasDefaultValue(1);
            ...
            // --- 2. THERAPIST TYPES (UZMAN TÜRLERİ) ---
            ...
            // --- 5. APPOINTMENT (RANDEVULAR) - GÜNCELLENDİ ---
            modelBuilder.Entity<Appointment>(entity =>
            {
                ...
                // YENİ ALANLAR
                entity.Property(e => e.Description).HasMaxLength(4000); // Notlar
            ...
            // --- 19. USER (KULLANICILAR) - GÜNCELLENDİ ---
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.IsDeleted).HasDefaultValue(0); // 0 = Silinmemiş
